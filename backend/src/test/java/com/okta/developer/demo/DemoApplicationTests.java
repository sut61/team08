...
public class DemoApplicationTests {
	...
	@Test
	public void DoctornameshortsizeTest(){
		//Doctorname short size
		Doctor doc = new Doctor();
		doc.setDoctorname("D");
		doc.setDoctorid("Octopus");
		doc.setPassword("55555");
		try {
			...
			assertEquals(violations.size(), 1);
			System.out.println();
			System.out.println("can detect short size Doctor");
			System.out.println(e);
			System.out.println();
		}
	}
	...
	@Test
	public void DoctoridshortsizeTest(){
		//Doctorid short size
		Doctor doc = new Doctor();
		doc.setDoctorname("Dr.Octopus");
		doc.setDoctorid("O");
		...
		try {
			...
			assertEquals(violations.size(), 1);
			System.out.println();
			System.out.println("can detect short size Doctorid");
			System.out.println(e);
			System.out.println();
		}
	}
	...
	@Test
	public void PasswordshortsizeTest(){
		//Password short size
		Doctor doc = new Doctor();
		doc.setDoctorname("Dr.Octopus");
		doc.setDoctorid("Octopus");
		...
		try {
			...
			assertEquals(violations.size(), 1);
			System.out.println();
			System.out.println("can detect short size Password");
			System.out.println(e);
			System.out.println();
		}
	}
